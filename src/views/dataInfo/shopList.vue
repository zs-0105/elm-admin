...
import { cityGuess, getResturants, getResturantsCount, foodCategory, updateResturant, searchplace, deleteResturant } from '@/api/shop'
export default {
    data() {
        return {
    ...
    methods: {
        ...
        addFood(index, row) {
            this.$router.push({ path: '/add/addGoods', query: { restaurant_id: row.id } })
        },
