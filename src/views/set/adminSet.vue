            ...
            <ul>
                ...
                <li>
                    ...
                    <el-upload class="avatar-uploader"
                        :action="'https://elm.cangdu.org/admin/update/avatar/' + adminInfo.id" :show-file-list="false"
                        :on-success="uploadImg" :before-upload="beforeImgUpload">
